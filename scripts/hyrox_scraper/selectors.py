...
SPLIT_SELECTORS = {
    ...
    "Run 4": "td.f-time_04",
    "Broad Jump Burpees": "td.f-time_14",
    "Run 5": "td.f-time_05",
    "Rowing": "td.f-time_15",
    "Run 6": "td.f-time_06",
...
SEGMENT_MAP: list[dict] = [
    ...
    {"order": 7,  "label": "Broad Jump Burpees",    "type": "station", "station_name": "Broad Jump Burpees",  "run_number": None},
...
YOUNGSTARS_SEGMENT_MAP_3_RUN: list[dict] = [
    ...
    {"order": 4,  "label": "Broad Jump Burpees", "type": "station", "station_name": "Broad Jump Burpees", "run_number": None},
