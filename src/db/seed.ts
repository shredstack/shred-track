...
const menOpenRefTimes: RefTimes = {
  ...
  "sled_push": [120, 160, 270],
  "1km_run_3": [220, 320, 420],
  "sled_pull": [195, 310, 450],
  "1km_run_4": [225, 330, 430],
  "burpee_broad_jump": [210, 330, 510],
  "1km_run_5": [230, 340, 450],
  "rowing": [210, 285, 390],
  "1km_run_6": [235, 350, 460],
  "farmers_carry": [75, 125, 210],
  "1km_run_7": [240, 360, 470],
  "sandbag_lunges": [210, 325, 480],
  "1km_run_8": [250, 370, 480],
  "wall_balls": [210, 360, 540],
};
...
const womenOpenRefTimes: RefTimes = {
  ...
  "sled_push": [100, 155, 270],
  "1km_run_3": [250, 350, 450],
  "sled_pull": [210, 330, 450],
  "1km_run_4": [255, 360, 460],
  "burpee_broad_jump": [240, 375, 570],
  "1km_run_5": [260, 370, 480],
  "rowing": [240, 305, 420],
  "1km_run_6": [265, 380, 490],
  "farmers_carry": [75, 130, 210],
  "1km_run_7": [270, 390, 510],
  "sandbag_lunges": [180, 285, 450],
  "1km_run_8": [280, 400, 520],
  "wall_balls": [195, 330, 510],
};
...
const menProRefTimes: RefTimes = {
  ...
  "sled_push": [120, 180, 300],
  "1km_run_3": [190, 260, 360],
  "sled_pull": [210, 330, 480],
  "1km_run_4": [195, 270, 370],
  "burpee_broad_jump": [180, 285, 420],
  "1km_run_5": [200, 280, 380],
  "rowing": [195, 255, 345],
  "1km_run_6": [205, 290, 390],
  "farmers_carry": [75, 135, 225],
  "1km_run_7": [210, 300, 400],
  "sandbag_lunges": [195, 330, 510],
  "1km_run_8": [215, 310, 420],
  "wall_balls": [210, 375, 570],
};
...
const womenProRefTimes: RefTimes = {
  ...
  "sled_push": [90, 140, 240],
  "1km_run_3": [220, 300, 410],
  "sled_pull": [180, 285, 420],
  "1km_run_4": [225, 310, 420],
  "burpee_broad_jump": [180, 300, 450],
  "1km_run_5": [230, 320, 430],
  "rowing": [210, 270, 360],
  "1km_run_6": [235, 330, 440],
  "farmers_carry": [60, 105, 180],
  "1km_run_7": [240, 340, 450],
  "sandbag_lunges": [150, 255, 390],
  "1km_run_8": [250, 350, 460],
  "wall_balls": [180, 300, 450],
};
