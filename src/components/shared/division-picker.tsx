...
export function DivisionPicker({
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      {/* Dropdown panel */}
      {isOpen && (
        <div className="rounded-xl border border-white/[0.08] bg-background shadow-xl overflow-hidden">
          {/* Search input */}
          <div className="sticky top-0 z-10 bg-background border-b border-white/[0.06] px-3 py-2">
            <div className="relative">
              ...
              <input
                ...
                autoFocus
                className="w-full rounded-lg bg-white/[0.04] border border-white/[0.08] pl-8 pr-8 py-2 text-xs placeholder:text-muted-foreground outline-none focus:border-primary/40"
              />
              {search && (
                <button
                  onClick={() => setSearch("")}
