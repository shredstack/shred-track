...
// Local (on-device) notification settings — morning brief, midday
// nudge, CrossFit log-by-deadline nudge, content toggles, Arnold
// opt-in, and a diagnostic panel. Rendered on both
// /settings/notifications and /settings/native so users find it
// wherever they look.
...
export function LocalNotificationSettings() {
  ...
  async function persist(next: TodayNotificationPrefs) {
    ...
    try {
      ...
      console.warn("[LocalNotificationSettings] persist failed", err);
    } finally {
      setBusy(false);
    }
  }
  ...
  return (
    <div className="space-y-4">
      <header className="space-y-1">
        <h2 className="text-base font-medium">Daily on-device reminders</h2>
        <p className="text-xs text-muted-foreground">
          Local push reminders from the iOS app. Separate from the per-category
          push toggles below.
        </p>
      </header>
      ...
      {!native && (
        <div className="rounded-md border border-yellow-500/30 bg-yellow-500/5 p-3 text-xs">
          These reminders only fire in the iOS app.
        </div>
      )}
      ...
      <section className="space-y-3 rounded-lg border border-border/60 bg-card/40 p-4">
        <div className="flex items-center justify-between gap-3">
          <div>
            <h3 className="text-sm font-medium">Morning brief</h3>
            <p className="text-xs text-muted-foreground">
      ...
      <section className="space-y-3 rounded-lg border border-border/60 bg-card/40 p-4">
        <div className="flex items-center justify-between gap-3">
          <div>
            <h3 className="text-sm font-medium">Midday score nudge</h3>
            <p className="text-xs text-muted-foreground">
      ...
      <section className="space-y-3 rounded-lg border border-border/60 bg-card/40 p-4">
        <div className="flex items-center justify-between gap-3">
          <div>
            <h3 className="text-sm font-medium">CrossFit log reminder</h3>
            <p className="text-xs text-muted-foreground">
      ...
      {/* Per-content toggles */}
      <section className="space-y-3 rounded-lg border border-border/60 bg-card/40 p-4">
        <h3 className="text-sm font-medium">Include in reminders</h3>
        <PrefRow
          label="HYROX plan"
      ...
      <section className="space-y-3 rounded-lg border border-border/60 bg-card/40 p-4">
        <div className="flex items-center justify-between gap-3">
          <div>
            <h3 className="text-sm font-medium">Arnold mode</h3>
            <p className="text-xs text-muted-foreground">
